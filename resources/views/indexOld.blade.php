            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    <div class="hero__caption">
                        ...
                        <P data-animation="fadeInUp" data-delay=".8s">Already a member? Sign in!. New to FishMart? Sign
                            up</P>
                        <!-- Hero-btn -->
                        <div class="hero__btn">
                            <a href="{{url('login')}}" class="btn hero-btn" data-animation="fadeInLeft"
                               data-delay=".8s">Login</a>
                            <a href="{{url('registration')}}" class="btn border-btn ml-15" data-animation="fadeInRight"
                               data-delay="1.0s">Sign Up</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Sell</a></h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Buy</a></h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Manage</a></h5>
